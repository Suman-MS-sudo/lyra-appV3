...
"[project]/src/app/api/billing/create-order/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        // Get invoice details
        const { data: invoice, error } = await serviceSupabase.from('organization_invoices').select('*, organizations(name, contact_email)').eq('id', invoiceId).single();
        if (error || !invoice) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            organizationName: invoice.organizations.name,
            invoiceNumber: invoice.invoice_number,
            keyId: ("TURBOPACK compile-time value", "rzp_live_lmKnnhDWFEBx4e")
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7f44bc68._.js.map