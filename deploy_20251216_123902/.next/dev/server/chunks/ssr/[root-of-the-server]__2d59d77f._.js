...
async function AdminDashboard() {
    ...
    const { data: profile } = await serviceSupabase.from('profiles').select('role, account_type').eq('id', user.id).single();
    ...
    let machineIds = [];
    if (isSuperCustomer) {
        const { data: machines } = await serviceSupabase.from('vending_machines').select('id').eq('customer_id', user.id);
    ...
    const machinesSelect = isSuperCustomer ? machinesQuery.select('*', {
        count: 'exact',
        head: true
    }).eq('customer_id', user.id) : machinesQuery.select('*', {
        count: 'exact',
        head: true
    });
    // Fetch dashboard stats and products
    const [{ count: totalMachines }, { count: totalUsers }, { count: totalTransactions }, { count: totalCoinPayments }, { data: recentMachines }, { data: recentTransactions }, { data: paidTx }, { data: coinPayments }, { data: products }] = await Promise.all([
        machinesSelect,
        serviceSupabase.from('profiles').select('*', {
            count: 'exact',
            head: true
        }).eq('role', 'customer'),
        isSuperCustomer && machineIds.length > 0 ? serviceSupabase.from('transactions').select('*', {
            count: 'exact',
            head: true
        }).in('machine_id', machineIds) : serviceSupabase.from('transactions').select('*', {
            count: 'exact',
            head: true
        }),
        isSuperCustomer && machineIds.length > 0 ? serviceSupabase.from('coin_payments').select('*', {
            count: 'exact',
            head: true
        }).in('machine_id', machineIds) : serviceSupabase.from('coin_payments').select('*', {
            count: 'exact',
            head: true
        }),
        isSuperCustomer ? serviceSupabase.from('vending_machines').select('name, location').eq('customer_id', user.id).order('created_at', {
            ascending: false
        }).limit(3) : serviceSupabase.from('vending_machines').select('name, location').order('created_at', {
            ascending: false
        }).limit(3),
        isSuperCustomer && machineIds.length > 0 ? serviceSupabase.from('transactions').select('total_amount, created_at, items').in('machine_id', machineIds).order('created_at', {
            ascending: false
        }).limit(3) : serviceSupabase.from('transactions').select('total_amount, created_at, items').order('created_at', {
            ascending: false
        }).limit(3),
        isSuperCustomer && machineIds.length > 0 ? serviceSupabase.from('transactions').select('total_amount').eq('payment_status', 'paid').in('machine_id', machineIds) : serviceSupabase.from('transactions').select('total_amount').eq('payment_status', 'paid'),
        isSuperCustomer && machineIds.length > 0 ? serviceSupabase.from('coin_payments').select('amount_in_paisa, dispensed').in('machine_id', machineIds) : serviceSupabase.from('coin_payments').select('amount_in_paisa, dispensed'),
        serviceSupabase.from('products').select('id, name, sku, price').order('created_at', {
            ascending: false
        })
    ]);
    // Calculate revenue by payment method
    const onlineRevenue = paidTx?.reduce((sum, tx)=>sum + parseFloat(tx.total_amount || 0), 0) || 0;
    const coinRevenue = (coinPayments?.reduce((sum, tx)=>sum + (tx.amount_in_paisa || 0), 0) || 0) / 100; // Convert paisa to rupees
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-3xl font-bold text-gray-900",
                                                    children: (totalTransactions || 0) + (totalCoinPayments || 0)
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/admin/dashboard/page.tsx",
                                                    lineNumber: 200,
                                                    columnNumber: 17
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: recentMachines && recentMachines.length > 0 ? recentMachines.map((machine, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "divide-y divide-gray-100",
                                        children: recentTransactions && recentTransactions.length > 0 ? recentTransactions.map((tx, i)=>{
                                            const items = typeof tx.items === 'string' ? JSON.parse(tx.items) : tx.items || [];
                                            const productNames = items.map((item)=>item.name).join(', ') || 'Product';
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "px-6 py-4 hover:bg-gray-50 transition-colors",
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "flex items-center justify-between",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d59d77f._.js.map