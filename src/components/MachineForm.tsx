...
export function MachineForm({ organizations, products }: MachineFormProps) {
  ...
  return (
    <form action={createVendingMachine} className="bg-white rounded-xl shadow-sm p-6 space-y-6">
      ...
      {/* Payment Modes */}
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-gray-900 border-b pb-2">Payment Modes</h3>
        ...
        <p className="text-xs text-gray-500 ml-7">Machine firmware must also be flashed with RFID-enabled firmware.</p>
      </div>
