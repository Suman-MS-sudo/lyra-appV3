  ...
  return (
    <div>
      <button
        ...
        disabled={loading}
        className="flex items-center gap-2 px-4 py-2 bg-[#1d1d1f] text-white rounded-lg hover:bg-black transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
      >
        {loading ? (
