          ...
          {success ? (
            <div className="text-center py-4">
              ...
              <p className="text-sm mb-8" style={{ color: '#334155' }}>
                A password reset link has been sent to <span className="font-medium" style={{ color: '#2563EB' }}>{email}</span>.
            ...
            <>
              ...
              <form onSubmit={handleResetRequest} className="space-y-4">
                ...
                <div className="text-center pt-1">
                  <Link href="/login" className="text-xs font-medium transition-colors hover:text-slate-900" style={{ color: '#2563EB' }}>
                    ← Back to Login
                  </Link>
                </div>
              </form>
