...
// ── Brand palette (mirrors the dashboard's white/blue theme) ──
const BRAND_PURPLE = rgb(0.145, 0.388, 0.922); // #2563EB
const BRAND_ROSE = rgb(0.129, 0.588, 0.953); // #0EA5E9
const BRAND_PINK = rgb(0.231, 0.510, 0.965); // #3B82F6
