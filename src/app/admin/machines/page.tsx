  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Vending Machines</h1>
          <p className="text-sm mt-0.5" style={{ color: '#334155' }}>Monitor and manage all machines</p>
        </div>
        <Link
      ...
      {machinesWithUpdatedStatus.length > 0 ? (
        ...
        >
          ...
          <p className="font-medium mb-1" style={{ color: '#334155' }}>No vending machines found</p>
          <p className="text-sm mb-6" style={{ color: '#64748b' }}>Add your first machine to get started</p>
          <Link
            href="/admin/machines/new"
