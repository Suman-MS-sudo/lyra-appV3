...
import { UserPlus, Users, Shield, User, Building2, ArrowLeft } from 'lucide-react';
...
export default async function UsersPage() {
  ...
  const { data: users, error } = await serviceSupabase
    ...
    .select(`
      ...
      created_at
    `)
    .in('account_type', ['customer', 'super_customer'])
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-3xl font-bold text-gray-900">
                    {users?.filter(u => u.account_type === 'customer').length || 0}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-purple-50 rounded-lg p-6 border border-purple-100">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-3xl font-bold text-gray-900">
                    {users?.filter(u => u.account_type === 'super_customer').length || 0}
                  </div>
                </div>
              </div>
            </div>
